...
import { CreateProjectTableColumns } from "../utils/CreateProjectTableColumns";
import { useGetCreateProjectQuery } from "../api/CreateServiceEndPoint";
import CreateProjectCategory from "../component/CreateProjectCategory";
...
const CreateBuilding = () => {
  ...
  const { data, isLoading } = useGetCreateProjectQuery({ ...filter });
  const showModal = () => {
    dispatch(
      setCommonModal({
        title: "Create Project",
        content: <CreateProjectCategory />,
        show: true,
        width: 700,
      })
    );
    ...
    <>
      <div>
        <Card
          ...
          //   },
          // }}
          title={`Create Project List (${data?.total || 0})`}
          style={{
