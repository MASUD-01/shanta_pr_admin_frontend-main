...
import { CreateUserTableColumns } from "../utils/CreateUserTableColumns";
import { useGetAddFlatsQuery } from "../api/AddFlatEndPoint";
import CreateUserDetailsCategory from "../component/CreateUserDetailsCategory";
  ...
  const showModal = () => {
    dispatch(
      setCommonModal({
        ...
        content: <CreateUserDetailsCategory />,
        show: true,
        width: 700,
      })
    );
    ...
    <>
      <div>
        <Card
          ...
          //   },
          // }}
          title={`Add User Details list (${data?.total || 0})`}
          style={{
