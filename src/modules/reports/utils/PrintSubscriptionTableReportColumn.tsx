...
export const PrintSubscriptionTableReportColumn =
  (): TableProps<ISubscriptionReport>['columns'] => {
    return [
      ...
      {
        title: <span>Subscription Amount</span>,
        dataIndex: 'subscription_amount',
        key: 'subscription_amount',
        width: 130,
      },
      {
        title: <span>Last Paid Amount</span>,
...
export default PrintSubscriptionTableReportColumn;
